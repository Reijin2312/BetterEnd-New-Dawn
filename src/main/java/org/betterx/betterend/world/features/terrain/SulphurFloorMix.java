...
public final class SulphurFloorMix {
     ...
     */
    public static BlockState pick(WorldGenLevel world, BlockPos pos) {
        if (!isBuried(world, pos) || facesOpenSpace(world, pos)) {
            return null;
        }
     ...
     */
    public static void apply(WorldGenLevel world, BlockPos pos) {
        BlockState state = pick(world, pos);
        if (state != null) {
     ...
     */
    public static boolean facesOpenSpace(WorldGenLevel world, BlockPos pos) {
