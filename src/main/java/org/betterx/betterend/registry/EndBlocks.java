...
public class EndBlocks {
    ...
    private static void registerBlocks() {
        ...
        SHADOW_PLANT = registerBlock( "shadow_plant", new TerrainPlantBlock(EndTags.SURVIVES_ON_SHADOW_GRASS) );
        BUSHY_GRASS = registerBlock( "bushy_grass", new TerrainPlantBlock(PINK_MOSS) );
        AMBER_GRASS = registerBlock( "amber_grass", new TerrainPlantBlock(EndTags.SURVIVES_ON_AMBER_MOSS) );
        ...
        JUNGLE_GRASS = registerBlock( "jungle_grass", new TerrainPlantBlock(CommonBlockTags.SOIL) );
        BLOOMING_COOKSONIA = registerBlock( "blooming_cooksonia", new TerrainPlantBlock(EndTags.SURVIVES_ON_END_MOSS) );
        SALTEAGO = registerBlock("salteago", new TerrainPlantBlock(EndTags.SURVIVES_ON_END_MOSS));
        VAIOLUSH_FERN = registerBlock("vaiolush_fern", new TerrainPlantBlock(EndTags.SURVIVES_ON_END_MOSS));
        FRACTURN = registerBlock("fracturn", new TerrainPlantBlock(EndTags.SURVIVES_ON_END_MOSS));
        ...
        ORANGO = registerBlock("orango", new TerrainPlantBlock(EndTags.SURVIVES_ON_RUTISCUS));
        AERIDIUM = registerBlock("aeridium", new TerrainPlantBlock(EndTags.SURVIVES_ON_RUTISCUS));
        LUTEBUS = registerBlock("lutebus", new TerrainPlantBlock(EndTags.SURVIVES_ON_RUTISCUS));
        LAMELLARIUM = registerBlock("lamellarium", new TerrainPlantBlock(EndTags.SURVIVES_ON_RUTISCUS));
