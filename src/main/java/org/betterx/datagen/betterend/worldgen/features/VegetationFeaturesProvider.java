...
public class VegetationFeaturesProvider extends WoverFeatureProvider {
    ...
    protected void bootstrapPlaced(BootstrapContext<PlacedFeature> context) {
        ...
        EndVegetationFeatures.CRYSTAL_MOSS_COVER.inlineConfiguration(context)
                                                ...
                                                .configuration(new MultifaceGrowthConfiguration((net.minecraft.world.level.block.MultifaceSpreadeableBlock) EndBlocks.CRYSTAL_MOSS_COVER, 6, true, true, true, 0.6f, HolderSet.direct(Block::builtInRegistryHolder, EndBlocks.CRYSTAL_MOSS, Blocks.END_STONE)))
                                                .inlinePlace()
                                                .countRange(2, 6)
                                                .onEveryLayer(1)
                                                .onlyInBiome()
